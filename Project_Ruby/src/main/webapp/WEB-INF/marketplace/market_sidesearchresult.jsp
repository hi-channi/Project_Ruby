...
$(function(){
	...
	$("#changebox").change(function(){
		if($("#changebox").is(":checked"))
		{
			...
			var checkon = 1;	
			location.href = '/marketplace/market_tradeablesidetest?&subtitle=${subtitle}&colorradio=${colorradio}&marketprice=${marketprice}&checkon='+checkon;
...
<%
	...
	String colorradio=request.getParameter("colorradio");
...
<div class="container">
	...
	<%--전체 테이블 --%>
	<c:forEach var="a" items="${SideSearchlist}">
