...
<div class="container">
	<div class="box">
		<form action="add" method="post" name="frm" onsubmit="return check(this)">
			...
			<div class="wrapper">
				<input type="text" class="input" name="nickname" placeholder="닉네임을 입력하세요" required="required" style="width: 360px;">
				<span class="underline"></span>
			</div>
			<div class="wrapper">
				<input type="date" class="input" name="birth" required="required" data-placeholder="생년월일을 입력하세요" style="width: 360px; color: #AAA;">
				<span class="underline"></span>
			</div>
			<div class="wrapper">
